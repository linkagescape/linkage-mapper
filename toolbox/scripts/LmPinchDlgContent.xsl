...
{ ]]>
  ...
  if ((window.document.body.clientWidth - 70) > 0)
  {
    <xsl:for-each select="Properties/PropertyGroup">
     <xsl:for-each select="Property">  
        <xsl:choose>
         <xsl:when test='PropertyName="Param5x" or PropertyName="Param5x" or PropertyName="param8x"'> 
        ...
        <xsl:when test="CtrlPlacement = 'side'">
          <TD>
            <TABLE>
                <TR>
                   <xsl:choose>
                     <xsl:when test= 'PropertyName="param6x" or PropertyName="param7x" or PropertyName="param8x"'> 
                        <TD class="lmsteppad">
                            <OBJECT width="100%" style="z-index: -1" classid="CLSID:{CtrlCLSID}" id="{CtrlName}" onfocus="ShowHelpTopic('{PropertyName}Topic');" /> 
                        </TD>
                     </xsl:when>                          
                     <xsl:when test= 'PropertyName="param8x"'> 
                        <TD class="lmsteppad2">
                            <OBJECT width="100%" style="z-index: -1" classid="CLSID:{CtrlCLSID}" id="{CtrlName}" onfocus="ShowHelpTopic('{PropertyName}Topic');" /> 
                        </TD>
                     </xsl:when>  
                     <xsl:when test='PropertyName="Param5x" or PropertyName="param8x"'> 
