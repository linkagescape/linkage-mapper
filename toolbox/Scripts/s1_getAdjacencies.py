...
def step1_get_adjacencies():
    ...
    try:
        ...
        if BUFFERDIST is not None:
            ...
            circlePointData = lu.get_bounding_circle_data(extentBoxList,0,0,BUFFERDIST)   
            ...
            GP.buffer_analysis(path.join(SCRATCHDIR, BNDCIRCEN), BNDCIRWD, "radius")
            ...
            boundingCirclePointArray  = zeros((0,5),dtype='float32')
            circlePointData = lu.get_bounding_circle_data(extentBoxList,0,0,0) # no buffer needed            
