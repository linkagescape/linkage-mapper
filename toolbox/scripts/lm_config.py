...
class Configure(object):
    ...
    LM_INPUTS = ["SCRIPT NAME", "PROJECT DIR", "CORE LAYER", "CORE FIELD", "RESISTANCE LAYER",
    ...
    CC_INPUTS = ["SCRIPT NAME", "PROJECT DIR", "CORE LAYER", "CORE FIELD", "CLIMATE LAYER",
                 "RESISTANCE LAYER", "GRASS GIS FOLDER", "MINEUCDIST", "MAXEUCDIST",
                 "CLIMATE THRESHOLD", "CLIMATE COST", "PRUNE NETWORK", "MAXNN",
                 "NN MEASURE UNIT", "CONSTELLATION"]
    LP_INPUTS = ["SCRIPT NAME", "PROJECT DIR", "COREFC", "COREFN", "RESRAST_IN", "OCAVRAST_IN",
                 ...
                 "FCERAST_IN", "CANALOG_MIN", "CANALOG_MAX", "CANALOG_MINRMAX", "CANALOG_TARGET",
                 "CANALOG_PIORITY", "CANALOG_WEIGHT", "CPREF_VALUE", "CPREF_MIN", "CPREF_MAX",
                 "CPREF_WEIGHT", "CLOSEWEIGHT", "PERMWEIGHT", "CAVWEIGHT", "ECIVWEIGHT",
                 "CEDWEIGHT", "CPSNORM_CUTOFF", "TRUNCWEIGHT", "LPWEIGHT", "OUTPUTFORMODELBUILDER",
                 "LPCUSTSETTINGS_IN", "CWDTHRESH", "RECHECK"]
    BM_INPUTS = ["SCRIPT NAME", "PROJECT DIR", "RESISTANCE LAYER", "START RADIUS", "END RADIUS",
                 "RADIUS STEP", "BARRIER METH", "SAVE RADIUS RASTERS", "WRITE PCT RASTERS"]
    CS_INPUTS = ["SCRIPT NAME", "PROJECT DIR", "CORE LAYER", "CORE FIELD", "CIRCUITSCAPE PATH"]
