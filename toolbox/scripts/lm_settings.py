...
MINCOSTDIST = None  # Minimum cost distance (Interger)
MINEUCDIST = None  # Minimum euclidean distance (Integer)
SAVENORMLCCS = False  # Save inidvidual normalized LCC grids (Boolean)
SIMPLIFY_CORES = True  # Simplify cores before calcuting distances (Boolean)
